...
class GroupeController extends AbstractController
{
    ...
    /**
     * @Route("/{groupeid}", name="groupe_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{groupeid}/edit", name="groupe_edit", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/{groupeid}", name="groupe_delete", methods={"POST"})
     */
    public function delete(Request $request, Groupe $groupe): Response
    {
        if ($this->isCsrfTokenValid('delete'.$groupe->getGroupeid(), $request->request->get('_token'))) {
            $entityManager = $this->getDoctrine()->getManager();
