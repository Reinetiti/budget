...
class ExerciceController extends AbstractController
{
    ...
    /**
     * @Route("/{annee}", name="exercice_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{annee}/edit", name="exercice_edit", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/{annee}", name="exercice_delete", methods={"POST"})
     */
    public function delete(Request $request, Exercice $exercice): Response
    {
        if ($this->isCsrfTokenValid('delete'.$exercice->getAnnee(), $request->request->get('_token'))) {
            $entityManager = $this->getDoctrine()->getManager();
