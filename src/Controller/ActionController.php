...
class ActionController extends AbstractController
{
    ...
    public function new(Request $request): Response
    {
        ...
        // $search_action = $this-> entityManager-> getRepository(Action::class)->findOneByactionid($Action->getactionid());
    }

    /**
     * @Route("/{actionid}", name="action_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{actionid}/edit", name="action_edit", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/{actionid}", name="action_delete", methods={"POST"})
     */
    public function delete(Request $request, Action $action): Response
    {
        if ($this->isCsrfTokenValid('delete'.$action->getActionid(), $request->request->get('_token'))) {
            $entityManager = $this->getDoctrine()->getManager();
