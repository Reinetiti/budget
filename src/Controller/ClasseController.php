...
class ClasseController extends AbstractController
{
    ...
    /**
     * @Route("/{classeid}", name="classe_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{classeid}/edit", name="classe_edit", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/{classeid}", name="classe_delete", methods={"POST"})
     */
    public function delete(Request $request, Classe $classe): Response
    {
        if ($this->isCsrfTokenValid('delete'.$classe->getClasseid(), $request->request->get('_token'))) {
            $entityManager = $this->getDoctrine()->getManager();
